 ...
 * @category Options
 */
export type ServeOptions<R extends {
    [K in keyof R]: Bun.RouterTypes.RouteValue<Extract<K, string>>;
}> = (Omit<Bun.ServeOptions, "fetch" | "error"> | Bun.TLSServeOptions | Bun.UnixServeOptions | Bun.UnixTLSServeOptions) & {
    readonly routes?: R;
};
/**
 * @since 1.0.0
 ...
 */
export declare const make: <R extends {
    [K in keyof R]: Bun.RouterTypes.RouteValue<Extract<K, string>>;
} = {}>(options: ServeOptions<R>) => Effect.Effect<Server.HttpServer, never, Scope.Scope>;
/**
 * @since 1.0.0
 * @category layers
 */
export declare const layerServer: <R extends {
    [K in keyof R]: Bun.RouterTypes.RouteValue<Extract<K, string>>;
} = {}>(options: ServeOptions<R>) => Layer.Layer<Server.HttpServer>;
/**
 * @since 1.0.0
 * @category layers
 */
export declare const layer: <R extends {
    [K in keyof R]: Bun.RouterTypes.RouteValue<Extract<K, string>>;
} = {}>(options: ServeOptions<R>) => Layer.Layer<Server.HttpServer | Platform.HttpPlatform | Etag.Generator | BunContext.BunContext>;
/**
 ...
 * @category layers
 */
export declare const layerConfig: <R extends {
    [K in keyof R]: Bun.RouterTypes.RouteValue<Extract<K, string>>;
} = {}>(options: Config.Config.Wrap<ServeOptions<R>>) => Layer.Layer<Server.HttpServer | Platform.HttpPlatform | Etag.Generator | BunContext.BunContext, ConfigError.ConfigError>;
/**
