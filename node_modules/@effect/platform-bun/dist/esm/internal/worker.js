...
const platformWorkerImpl = /*#__PURE__*/Worker.makePlatform()({
  setup({
    ...
    return Effect.flatMap(Deferred.make(), closeDeferred => {
      ...
      }).pipe(Effect.interruptible, Effect.timeout(5000), Effect.catchAllCause(() => Effect.sync(() => worker.terminate())))), worker);
    });
  },
  listen({
    deferred,
